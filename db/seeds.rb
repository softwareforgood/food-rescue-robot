...
#region = Region.find_or_create_by({'name': 'TC ...'})
...
region = Region.create({
  ...
  website:'',
  website: '',
  address:'hannah@tcfoodjustice.org',
  notes:'',
  handbook_url:'',
...
20.times do |time|
  volunteer = Volunteer.create({
    email:"volunteer#{time}.TCFJ@gmail.com",
     name:"Volunteer#{time}",
...
super_admin = Volunteer.create({
  email:'superadmin.TCFJ@gmail.com',
   name:'Super Admin',
   password: 'changeme!',
   password_confirmation: 'changeme!',
   phone:'760-888-5555',
...
region_admin = Volunteer.create({
  email:'regionadmin.TCFJ@gmail.com',
